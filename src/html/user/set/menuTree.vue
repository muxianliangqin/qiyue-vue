    ...
    methods: {
      ...
      async init () {
        ...
        this.$http.get(this.url.findAllUser, (response) => {
          this.menuLoan.users = response.content.filter(v => {
            return v.id !== this.params.userId
          })
        })
      },
              ...
              if (data.edit) {
                ...
                if (data.children) {
                  ...
                  this.menuLoan.loanUserIds = data.menuLoan
                    .filter(v => {
                      return v.userId === this.params.userId
                    })
                    .map(v => {
                      return v.loanUserId
                    })
      ...
      checked (data) {
        ...
        checkedBoxes = checkedBoxes.map((v) => {
          return v.code
        })
